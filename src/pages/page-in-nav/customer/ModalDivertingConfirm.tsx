...
const ModalDivertingConfirm = (props: ModalDivertingProps) => {
  ...
  console.log("customer_inModalDiverting", customer);
    ...
    <div>
      ...
      >
        <div className="text-[15px] font-[400] text-[#8F9499] leading-[20px] tracking-[0.15px]">
          Bạn sẽ được chuyển qua khung chat zalo để tương tác với người dùng
          <span className="font-[600] text-[#36383A] text-[14px] leading-[24px] tracking-[0.25px]">
            {" " + customer?.name}
          </span>
          .
          {hasZaloId && (
            <div className="text-[red]">Khách hàng không có Zalo ID.</div>
          )}
        </div>
      </Modal>
    </div>
